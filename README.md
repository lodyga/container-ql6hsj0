...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ql6hsj0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ql6hsj0.containers.anotherwebservice.com/
...
```
git clone git@github.com:lodyga/container-ql6hsj0.git
cd container-ql6hsj0
```
...
```
docker attach container-ql6hsj0
```
